...
public class IProduto{
    public static void GerenciarProdutos(List<Produto> produtos)
    {
        while (true)
        {
            Console.WriteLine("\nGERENCIAR PRODUTOS");
    ...
    public static void AdicionarProduto(List<Produto> produtos)
    {
        Console.WriteLine("\nADICIONAR PRODUTO");
    ...
    public static void ModificarProduto(List<Produto> produtos)
    {
        Console.WriteLine("\nMODIFICAR PRODUTO");

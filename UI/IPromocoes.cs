...
public class IPromocoes{
    public static void MostrarPromocoes(List<Promocao> promocoes)
    {
        Console.WriteLine("\nLISTA DE PROMOÇÕES");
    ...
    public static void AdicionarPromocao(List<Promocao> promocoes, List<Produto> produtos)
    {
        Console.WriteLine("\nADICIONAR PROMOÇÃO");
    ...
    public static void ModificarPromocao(List<Promocao> promocoes)
    {
        Console.WriteLine("\nMODIFICAR PROMOÇÃO");
    ...
    public static void ExcluirPromocao(List<Promocao> promocoes)
    {
        Console.WriteLine("\nEXCLUIR PROMOÇÃO");
